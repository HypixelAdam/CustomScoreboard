...
public class DeleteLine implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String l, String[] a) {
		...
		int length = a.length;
		if (cmd.getName().equalsIgnoreCase("cedelline")) {
			if (!p.hasPermission("customscoreboard.editcommand.delline")) {
